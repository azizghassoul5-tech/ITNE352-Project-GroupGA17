...
class NewsClient:
    ...
    def display_main_menu(self):
        ...
        print("\n" + "="*50)
        print("🗞️  NEWS SERVICE SYSTEM - MAIN MENU")
        print("="*50)
    ...
    def display_headlines_list(self, response):
        ...
        for article in articles:
            ...
            print(f"   📡 Source: {article['source']} | ✍️  Author: {article['author']}")
            print("-" * 80)
    ...
    def display_sources_list(self, response):
        ...
        for i, source in enumerate(sources):
            print(f"\n{i}. 📺 {source['name']}")
            print(f"   🌍 {source['country']} | 📂 {source['category']} | 🗣️  {source['language']}")
            print("-" * 80)
    ...
    def display_source_details(self, source):
        ...
        print(f"🗣️  Language: {source['language']}")
